<!-- PROFILE README · Miguel Basaglia -->

<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=0:050b16,50:0b1f3a,100:00d9ff&height=190&section=header&text=MIGUEL%20BASAGLIA&fontSize=48&fontColor=eaf8ff&fontAlignY=42&desc=SYSTEM%20ONLINE%20%E2%80%A2%20FULL-STACK%20DEVELOPER%20IN%20TRAINING&descAlignY=62&descSize=14&animation=fadeIn" width="100%" alt="Miguel Basaglia — System Online" />

  <a href="https://github.com/Basaglia08">
    <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=19&duration=2800&pause=900&color=00D9FF&center=true&vCenter=true&width=740&lines=%3E+booting+developer_profile.exe...;%3E+Full-stack+developer+in+continuous+evolution.;%3E+Building+ideas+with+code%2C+design+and+AI.;%3E+Welcome+to+my+digital+space." alt="Typing SVG" />
  </a>
...
║  Status    : Construindo, estudando e evoluindo.                 ║
╚══════════════════════════════════════════════════════════════════╝
```
...
public class MissaoAtual {
    public static void main(String[] args) {
        String developer = "Miguel Basaglia";

        String[] concluidos = {
            "Fundamentos de desenvolvimento web",
            "Projetos práticos e aprendizados publicados"
        };

        String[] emEvolucao = {
            "React e TypeScript",
            "Back-End com PHP/Laravel e Node.js",
            "Soluções com IA generativa"
        };

        String proximaMissao = "Colaborar com a comunidade open source";

        System.out.println("Código é aprendizado em execução.");
    }
}
```
